...
def chamar_omie(modulo: str, call: str, param: dict, tentativas: int = 4) -> dict:
...
def buscar_movimentos_financeiros(nCodCC: int, nomes_departamento: dict) -> dict:
...
def montar_lookup_titulos() -> dict:
    ...
    lookup_geral = {}
    for conta in CONTAS:
        lookup_conta = buscar_movimentos_financeiros(conta["nCodCC"], nomes_departamento)
...
def coletar_dados() -> list:
    ...
    lookup_titulos = montar_lookup_titulos()
...
<header>
  <div class="marca">
    ...
    <div class="marca-texto">
      <div class="marca-nome">PRIME SOL <span class="marca-destaque">MATRIZ</span></div>
